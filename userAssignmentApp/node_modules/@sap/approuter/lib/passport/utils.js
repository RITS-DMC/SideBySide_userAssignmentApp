...
const stdTTL              = parseInt(process.env.STATE_CACHE) || 60;
const checkperiod         = stdTTL + 20;
const stateCache          = new NodeCache({stdTTL: stdTTL, checkperiod: checkperiod});
...
module.exports = {
  ...
  setCacheStateValue: function (state) {
    stateCache.set(state, state);
  },

  getCacheStateValue: function (state) {
